...
<?php
	...
	function generateTaskTableHTML($tasks, $message, $orderBy, $orderDirection) {
		...
		$html .= "<p><a class='taskButton' href='page1.php?target=taskform'>+ Add Task</a></p>\n";
		...
		foreach ($columns as $column) {
			...
			$html .= "<th><a class='order' href='page1.php?orderby=$name'>$label</a></th>";
		}
